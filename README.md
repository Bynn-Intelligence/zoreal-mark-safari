...
render. The verifier it embeds is `@zoreal/mark-verify` from npm. Not yet: the App Store
listing, whose builds are uploaded and await screenshots, and the production record
service keys. This section is kept true.
